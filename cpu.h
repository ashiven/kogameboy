...
void rrla(CPU *cpu, enum RegisterName target);
void cpl(CPU *cpu, enum RegisterName target);
void bit(CPU *cpu, enum RegisterName target);
void reset(CPU *cpu, enum RegisterName target);
void set(CPU *cpu, enum RegisterName target);
